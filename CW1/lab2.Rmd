...
f1 <- read.csv("http://goo.gl/Zjr9aF", sep = ",")
...
### 1.1 meanSDuration <- mean(f1$s.duration.ms)

### 1.2 medianSDuration <- median(f1$s.duration.ms) 

## Calculate standard deviation and standard error of [s] duration using sd() and se()
Please provide the answers below.

### 1.3  standardDeviationS <- sd(f1$s.duration.ms)

### 1.4  

## Provide a summary of your data set

### 1.5  summaryOfF1 <- summary(f1)
